...
- The **year story** is the artifact people return to.
...
**This Month** is a recurring, voluntary conversation:

> Did anything in your life change that taxes should know?

Taxfix translates answers into structured **life facts** for the current tax year. The product is the check-in plus the story of the year so far — not a form, not a countdown, not a wallet of fake points.
...
1. **Invite** — Named by month: “November is ready.” Tone: opportunity, not obligation.
2. **Five yes/no life questions** — About the person’s life this month, in plain language. Tax categories stay backstage.
3. **Follow-up only on yes** — One short fact per yes (e.g. typical WFH days, commute km, a donation amount). No interrogation after a no.
4. **Write the year story** — Each answer adds or confirms a line Taxfix already knows.
...
### The year story (the return object)

After check-ins, the user can see a calm list of **what Taxfix already knows this year** — in life language, then a light translation:

- “You work from home 3 days a week — that is the home-office lump sum, already noted.”
- “Commute is 14 km — distance is locked unless you tell us you moved.”

This is the reason to come back next month: **keep the story true**, not to protect a streak.
...
- Short follow-ups that store life facts.
- Year story: what we already know, in calm language.
...
- As a Taxfix user, I want to see what Taxfix already knows about my year, so that I feel in control when I open the app off-season.
...
- Unauthenticated visitors do not see another person’s check-in or year story.
- Authenticated User: create/update **their** monthly check-ins and life facts only.
...
- **Life facts:** typed facts derived from answers (e.g. commute km, WFH days, donation amount), valid for a period, owned by User.
- **Year story:** a read model over life facts + check-in completion, not a separate social feed.
...
| Brief                                       | This Month                                               |
| ------------------------------------------- | -------------------------------------------------------- |
| Voluntary, recurring, outside filing season | Monthly check-in; value is the conversation + year story |
| Not reminders / nudges                      | No notification theatre; pull, not push                  |
| Real value                                  | Facts captured while true; July gets easier              |
| Return loop                                 | Next month’s check-in + maintaining the year story       |
...
- **Weak pull without notifications.** If the year story is not emotionally rewarding, people will not return. Mitigation: close feeling must be pride/control, and catch-up must be available when they do open.
...
- **Hackathon time.** The idea is small on purpose so a later build can stay a vertical slice of _one month + year story_.
...
1. **Hero object:** Year story only vs a small labeled euro footnote. Default: story only.
2. **Language:** English UI for speed vs German copy for brand authenticity. Default: English UI, German tax terms in the engine/story translations.
3. **First-run:** Empty year vs “catch up the year so far” as the default first visit. Default: offer catch-up, do not force it.
